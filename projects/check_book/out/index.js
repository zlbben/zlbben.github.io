...
function startUp() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(books.map((val) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield page.goto(val.url[0]);
            let info = yield page.$eval(piaotian.NEW_TEXT, (el) => ({ text: el.innerText, href: el.href }));
            info.name = val.name;
            info.url = val.url;
        ...
        fs_1.default.writeFileSync(histryPath, JSON.stringify(updateHistry, undefined, 2), { encoding: 'utf8' });
        yield browser.close();
    });
}
startUp();
